...
def hydro_segment_computer(in_txt, in_fasta, field_keyword, scale, number_max_iter=False):
    ...
    UHS_hydro_dict = {'A':0.16, 'C':-0.01, 'D':-0.73, 'E':-0.7, 'F':0.46, 'G':0.2, 'H':-0.38, 'I':0.39, 'K':-0.9, 'L':0.3, 'M':0.2, 'N':-0.5, 'P':-0.5, 'Q':-0.46, 'R':-0.55, 'S':-0.06, 'T':0.01, 'V':0.25, 'W':0.03, 'Y':0.12, 'X':0.0, 'B':0.0, 'U':0.0, 'Z':0.0}
